...
contract AMeta is ERC721, Ownable {
  ...
  constructor() ERC721("AMeta", "AMV") {
    setHiddenMetadataUri("ipfs://__CID__/hidden.json");
    buildings.push(Building("ZERO", 0,0,0,0,0,0));
    buildings.push(Building("House",1,3,2,2,0,3));
    buildings.push(Building("Zhouse",2,5,4,10,0,6));
    buildings.push(Building("Chill House",1,1,2,7,0,-7));
    buildings.push(Building("Club",1,6,2,10,0,0));
    buildings.push(Building("lol house",2,3,1,-9,0,-9));
    ...
    buildings.push(Building("Beach club",3,1,3,-4,0,-5));
    buildings.push(Building("playground",2,2,3,-10,0,0));
    buildings.push(Building("Shop",3,2,2,-3,0,-2));
  }
